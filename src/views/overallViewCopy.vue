...
const onSlideChange = (swiper) => {
  ...
  console.log(rooms[swiper.realIndex].key)
  handleSwitchButtonClick(rooms[swiper.realIndex].key)
};
...
.home .vr {
  ...
  left: 0;
  z-index: 11;
  -webkit-animation: slideInLeft 1s 0.15s;
  animation: slideInLeft 1s 0.15s;
...
.home .switch .button .text {
  color: #fff;
  font-size: 24px;
  font-weight: 600;
}

.home .switch .button:not(last-child) {
  margin-bottom: 48px;
}

.home .switch .button .icon {
  display: inline-block;
  height: 30px;
  width: 30px;
...
.home .point .label::before,
.home .point .label::after {
  display: inline-block;
  content: '';
  background: #fff;
  height: 100%;
...
.home .point .label .label-tips .cover {
  width: 80px;
  height: 100%;
}

.home .point .label .label-tips .cover .icon {
  display: inline-block;
  height: 100%;
  width: 100%;
...
.home .point .label .label-tips .info {
  width: calc(100% - 80px);
  height: 100%;
  overflow: hidden;
  padding-left: 12px;
...
.home .point .label .label-tips .info p {
  overflow: hidden;
...
.home .point .label .label-tips .info p.p1 {
  font-size: 24px;
  color: #1d1f24;
  font-weight: 800;
  margin: 12px 0 2px;
...
.home .point .label .label-tips .info p.p2 {
  font-size: 18px;
  color: #00aa47;
  font-weight: 500;
}

.home .point .label.label-sofa .label-tips {
  left: -220px;
  flex-direction: row-reverse;
}

.home .point .label.label-sofa .label-tips .info {
  padding: 0 12px 0 0;
}

.home .point .label.label-sofa .label-tips .info p {
  text-align: right;
}
...
.home .point:hover .text {
  opacity: 1;
}

.home .point.visible .label {
  transform: scale(1, 1);
}
